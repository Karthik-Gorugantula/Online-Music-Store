...
<head>
        ...
        <title>Music Records Page</title>
...
<body>
    ...
    ?>  
        ...
        <div class="container mt-2">
            <div id="message"></div>
            <img src="https://i.postimg.cc/QMwK5bJv/maxresdefault.jpg" class="mt-3 mb-3" alt="" width="100%">
            <div class="row mt-2 pb-3">
                <?php
                    include 'connection.php';
                    $data_g = $con->prepare('SELECT * FROM products WHERE catid=5');
                    $data_g->execute();
