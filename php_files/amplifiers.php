...
<body>
    ...
    ?>  
        ...
        <div class="container mt-2">
            <div id="message"></div>
            <img src="https://i.postimg.cc/jSMm1dDV/head.jpg" class="mt-3 mb-3" alt="" width="100%">
            <div class="row mt-2 pb-3">
                <?php
                    include 'connection.php';
                    $data_g = $con->prepare('SELECT * FROM products WHERE catid=4');
                    $data_g->execute();
                    $result = $data_g->get_result();
                    while ($row = $result->fetch_assoc()):
                ?>
                <div class="col-sm-6 col-md-4 col-lg-3 mb-2 ms-5 me-5">
                    <div class="card-deck mt-3">
                        <div class="card p-2 pb-2 border-secondary mb-3" style="border: 2px solid black; box-shadow: 2px 2px 5px solid black">
                            <img src="<?= $row['pimage'] ?>" class="card-img-top" height="220" width="180">
