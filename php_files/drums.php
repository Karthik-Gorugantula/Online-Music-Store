...
<body>
    ...
    ?>  
        ...
        <div class="container mt-2">
            <div id="message"></div>
            <img src="https://i.postimg.cc/mZzXM7c7/head.jpg" class="mt-3 mb-3" alt="" width="100%">
            <div class="row mt-2 pb-3">
                <?php
                    include 'connection.php';
                    $data_g = $con->prepare('SELECT * FROM products WHERE catid=2');
                    $data_g->execute();
                    $result = $data_g->get_result();
                    while ($row = $result->fetch_assoc()):
                ?>
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3 ms-5 me-5">
